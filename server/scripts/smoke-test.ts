...
const importResult = await ctx.drugEntryService.importWithPlugin("label-text", {
  saveMode: "preview",
  actor: "smoke-test",
  basic: { generic_cn: "示例测试药物", generic_en: "Example Test Drug", system: "western_medicine", primary_category: "anti_infective", secondary_category: "antibacterial", pharmacologic_class: "示例分类", prescription_type: "prescription" },
