...
export function categoryLabel(value) { return label(state.taxonomies?.drugCategories.categories, value); }
export function routeLabel(value) { return label(state.taxonomies?.routes, value); }
export function dosageFormLabel(value) { return label(state.taxonomies?.dosageForms, value); }
export function riskTagLabel(value) { return label(state.taxonomies?.riskTags, value); }
export function renderDrugCard(drug) {
